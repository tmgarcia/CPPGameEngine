...
public:
	...
	void sendUniformParameter(GLuint programID,	ShaderUniformParameter parameter);
	void sendUniformParameter(GLuint programID, const char* name, ParameterType parameterType,const float* value);
	void sendIntUniformParameter(GLuint programID, const char* name, GLint value);
