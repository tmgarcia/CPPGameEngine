...
{ 
	...
	vec4 newObjectColor = vec4(compRand1(), compRand1(), compRand1(), 1);
	theFinalColor= (ambientColor + vec4(brightness, brightness, brightness, 1))* newObjectColor + specularLighting;
}